    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img class="img-profile rounded-circle" src="https://scontent.fhph2-1.fna.fbcdn.net/v/t1.15752-9/362979440_813898477006067_4607661482292697642_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=ae9488&_nc_ohc=K2SGXaGXy1QAX-OwTqm&_nc_ht=scontent.fhph2-1.fna&oh=03_AdSnfLyE4tcknbakonWRK2no2GMOkJ259v7VQhrlyXcRWQ&oe=65083186">
        </a>
